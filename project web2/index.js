...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "8414721609:AAGTZ2iYglCpbjWqvsbRpJpSsA5VMqXfEBY";
const OWNER_ID = "6754186040";
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="logo-container">
        <div class="logo-ring"></div>
        <img src="https://i.top4top.io/p_3590b6bk90.jpg" class="logo" alt="APOCALYPSE Logo">
      </div>
      <div class="app-title">APOCALYPSE</div>
  ...
  <div class="main-content">
    ...
    <div class="server-banner">
      <video class="banner-video" autoplay muted loop playsinline>
        <source src="https://files.catbox.moe/25yaju.mp4" type="video/mp4">
        Your browser does not support the video tag.
      </video>
      <div class="banner-content">
        <div class="banner-title">APOCALYPSE</div>
        <div class="banner-time">
          <i class="fas fa-clock"></i>
          <span id="currentTime">Loading...</span>
        </div>
    ...
    <div class="form-section">
      ...
      <div class="bug-selector-container">
        ...
        <div class="bug-options-container" id="bugOptionsContainer">
          <button class="bug-option-btn" data-mode="andros">FC INVISIBLE</button>
        ...
        <div class="selected-bug-display" id="selectedBugDisplay">
          <div class="terminal-line">
            <span class="terminal-prompt">user@APOCALYPSE:~$</span>
